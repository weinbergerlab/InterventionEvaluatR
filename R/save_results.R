syncon.save <- function (analysis, output_file) {
  ...
  saved = list(
    ...
    input=list(
      ...
      n_seasons=analysis$n_seasons, year_def=analysis$year_def, 
      group_name=analysis$group_name, date_name=analysis$date_name, 
      outcome_name=analysis$outcome_name, denom_name=analysis$denom_name
    ),
