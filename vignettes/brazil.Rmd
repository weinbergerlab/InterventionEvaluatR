...
##Cases averted
How many cases were prevented from the time of vaccine introduction to the last time point?
You can modify the number 'last.point' to pull out the cumulative number of cases at any point in the time series
```{r}
