...
country       <- 'Chile' #Country or region name.
...
file_name="Dataset%20S2%20Chile.csv"
...
end_date          <- as.Date('2012-12-01') #"YYYY-MM-01" Indicates the date of the last data point.
