...
setwd("C:/Users/dmw63//Weinberger Lab Dropbox/PAHO mortality/Results/HDI/SubChapterLevel/Monthly/best model wo pandemic unbias")
country <- "PAHO_ar"
...
tiff(paste0('C:/Users/dmw63/Weinberger Lab Dropbox/PAHO mortality/Results/Forest plots/with unbiasing/forest.natl_',ds.select,'.tiff'),
