...
```{r figs1, fig.width=5, fig.height=3, fig.align = "center", dpi=300, echo=FALSE}
...
##Plots
```{r plots2,fig.height =3 , fig.width = 5, fig.align = "center", dpi=300,results = 'asis'}
