...
list[impact_full, impact_time, impact_time_no_offset, impact_pca] <- syncon.impact(data_full, data_time, data_time_no_offset, data_pca, intervention_date, time_points, n_seasons, crossval)
```

```{r crossval, include = FALSE}
  if(crossval){
    list[ann_pred_quantiles_stack, pred_quantiles_stack, rr_roll_stack, rr_mean_stack, rr_mean_stack_intervals, cumsum_prevented_stack] <- syncon.main(data_full, data_time, data_time_no_offset, data_pca, intervention_date, time_points, n_seasons, crossval)
