...
country <- "ar"
dt <-read.csv(file = paste(country,"_SubChpt_BestModel_woPandemic_rr_best.csv",sep=""))
colnames(dt) <- c("age_group","Lower","Median","Upper")
country <- "br"
dt1 <-read.csv(file = paste(country,"_SubChpt_BestModel_woPandemic_rr_best.csv",sep=""))
...
# country <- "PAHO_ar"
# dt <-read.csv(file = paste(country,"/",country,"_rr_best.csv",sep=""))
# colnames(dt) <- c("age_group","Lower","Median","Upper")
# country <- "PAHO_br"
# dt1 <-read.csv(file = paste(country,"/",country,"_rr_best.csv",sep=""))
# colnames(dt1) <- c("age_group","Lower","Median","Upper")
# dt <- rbind(dt,dt1)
# country <- "PAHO_co"
# dt1 <-read.csv(file = paste(country,"/",country,"_rr_best.csv",sep=""))
...
tiff('C:/Users/dmw63/Weinberger Lab Dropbox/PAHO mortality/Results/Forest plots/forest.natl.tiff',
